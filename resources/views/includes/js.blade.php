...
<script src="{{ 'sets/js/icons/feather-icon/feather.min.js' }}"></script>
<script src="{{ 'sets/js/icons/feather-icon/feather-icon.js' }}"></script>
<script src="{{ 'sets/js/sidebar-menu.js' }}"></script>
<script src="{{ 'sets/js/config.js' }}"></script>
<script src="{{ 'sets/js/bootstrap/popper.min.js' }}"></script>
<script src="{{ 'sets/js/bootstrap/bootstrap.min.js' }}"></script>
