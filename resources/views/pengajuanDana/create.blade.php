                    ...
                    <div class="card-body">
                        <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-6 col-sm-4">
                                            <label class="imagecheck mb-4">
                                                ...
                                                <figure class="imagecheck-figure">
                                                    <img src="{{ asset('/partas/img/examples/product1.jpg') }}"
                                        ...
                                        <div class="col-6 col-sm-4">
                                            <label class="imagecheck mb-4">
                                                ...
                                                <figure class="imagecheck-figure">
                                                    <img src="{{ asset('/partas/img/examples/product4.jpg') }}"
                                                        alt="title" class="imagecheck-image">
                                                </figure>
                                            </label>
                                        </div>
                                        <div class="col-6 col-sm-4">
                                            <label class="imagecheck mb-4">
                                                <input name="imagecheck" type="checkbox" value="3"
                                                    class="imagecheck-input">
                                                <figure class="imagecheck-figure">
                                                    <img src="{{ asset('/partas/img/examples/product3.jpg') }}"
                                                        alt="title" class="imagecheck-image">
                                                </figure>
                                            </label>
                                        </div>
                            ...
                            <div class="col-md-6 col-lg-4">
                                ...
                                <div class="form-group form-floating-label">
                                    <input id="inputFloatingLabel2" type="text" class="form-control input-solid"
                                        required>
