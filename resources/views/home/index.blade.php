                ...
                <div class="col-md-8">
                    <div class="card card-chart" style="border-radius: 9px;">
                        ...
                        <div style="position: relative; bottom:20px;">
                            @foreach ($monthly_pengajuan_dana as $data)
                                <div class="total_pengajuan_dana" style="position: relative; left:75px; top:5px;">
                                    ...
                                    <span style="font-size: 13px; font-weight: bold; color:#484E50">
                                        Total
                                    </span>
                                    <span style="font-size: 14px; font-weight: bold; color:#484E50">
                                        :
                                    </span>
                                    <span style="font-size: 14px; font-weight: bold; color:#FF1755">
                                        {{ $data->total }}
                                    </span>
                                </div>
                            @endforeach
                            ...
                            @foreach ($monthly_pengajuan_spk as $data)
                                <div class="total_pengajuan_dana" style="position: relative; left:189.4px; bottom:17px;">
                                    <span class="fas fa-circle"
